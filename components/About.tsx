  ...
  return (
    <section id="about" className="py-20 px-4 md:px-8 bg-background">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-5xl md:text-6xl font-bold text-center mb-16 text-white text-balance">
          About Krigo
        </h2>
          ...
          <div>
            ...
            <div className="flex gap-8 pt-4">
              <div>
                ...
                <p className="text-gray-400">Premium Dishes</p>
              </div>
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-muted p-8 rounded-lg text-center hover:shadow-xl transition">
            <Image
            ...
            />
            <h3 className="text-gold text-xl font-bold">Excellence</h3>
            <p className="text-gray-400 mt-2">Committed to serving the finest dining experience</p>
          </div>
          ...
          <div className="bg-muted p-8 rounded-lg text-center hover:shadow-xl transition">
            <Image
              ...
              className="w-full h-48 object-cover rounded-lg mb-4"
            />
            <h3 className="text-gold text-xl font-bold">Renowned</h3>
            <p className="text-gray-400 mt-2">A beloved destination for food enthusiasts</p>
          </div>
          ...
          <div className="bg-muted p-8 rounded-lg text-center hover:shadow-xl transition">
            <Image
              ...
              className="w-full h-48 object-cover rounded-lg mb-4"
            />
            <h3 className="text-gold text-xl font-bold">Elegant</h3>
            <p className="text-gray-400 mt-2">Experience sophistication in every detail</p>
          </div>
        </div>
      </div>
    </section>
