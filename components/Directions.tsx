export default function Directions() {
  return (
    <section id="directions" className="py-20 px-4 md:px-8 bg-secondary/20">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-5xl md:text-6xl font-bold text-center mb-4 text-foreground text-balance">
          Find Us
        </h2>
        <p className="text-center text-primary text-lg mb-12 text-pretty">
          Visit our elegant restaurant at this location
        </p>
        
        <div className="flex justify-center rounded-lg overflow-hidden shadow-2xl mb-12">
          <iframe 
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-lg">
            ...
            <span className="text-primary">Reserve your table today</span>
          </p>
        </div>
      </div>
    </section>
